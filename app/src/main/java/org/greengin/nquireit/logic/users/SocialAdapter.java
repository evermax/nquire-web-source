...
public class SocialAdapter implements SignInAdapter, ConnectionSignUp {
    ...
    public String signIn(String localUserId, Connection<?> connection, NativeWebRequest request) {
        ...
        UserProfile user = userServiceBean.providerSignIn(oauthProfile.getEmail(), data.getProviderId(), data.getProviderUserId());
    ...
    public String execute(Connection<?> connection) {
        ...
        if (current == null) {
            ...
            ConnectionData data = connection.createData();
            UserProfile user = userServiceBean.providerSignIn(profile.getEmail(), data.getProviderId(), data.getProviderUserId());
